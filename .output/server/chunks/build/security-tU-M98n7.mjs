...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const certifications = [
      { badge: "\u{1F6E1}\uFE0F", name: "ISO 27001", description: "Information security management certification" },
      { badge: "\u{1F3DB}\uFE0F", name: "PSD2 Licensed", description: "FCA authorized payment institution" },
      { badge: "\u{1F510}", name: "eIDAS Compliant", description: "Electronic identification and trust services" },
...
//# sourceMappingURL=security-tU-M98n7.mjs.map
