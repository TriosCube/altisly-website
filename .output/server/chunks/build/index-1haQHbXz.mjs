...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const categories = computed(() => {
      ...
      (_a = posts.value) == null ? void 0 : _a.forEach((p) => cats.add(p.category));
    ...
    const categoryStyle = (cat) => {
      ...
      return (_a = map[cat]) != null ? _a : { badge: "bg-gray-100 text-gray-700" };
    };
                ...
                return [
                  ...
                  createVNode("div", { class: "flex-1 p-8 md:p-10 flex flex-col justify-between" }, [
                    createVNode("div", null, [
                      createVNode("p", { class: "text-xs text-gray-400 font-medium mb-3" }, toDisplayString(formatDate(unref(filteredPosts)[0].createdAt)) + " \xB7 " + toDisplayString(readTime(unref(filteredPosts)[0].content)), 1),
...
//# sourceMappingURL=index-1haQHbXz.mjs.map
