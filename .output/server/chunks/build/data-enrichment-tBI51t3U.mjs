...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const rawData = [
      "AMZN MKTP UK*AB12C 0203 AMAZON.CO.UK GB  \xA348.99",
      "TFL*TRAVEL CH 0343 CHARGE \xA34.50",
      "NETFLIX.COM 866-579-7172 CA  \u20AC13.99",
      "TESCO STORES 3455 METRO LONDON  \xA323.14"
    ];
    const enrichedData = [
...
//# sourceMappingURL=data-enrichment-tBI51t3U.mjs.map
